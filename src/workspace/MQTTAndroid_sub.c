...
void usage()
{
	printf("MQTTAndroid Native subscriber\n");
	printf("Usage: mosquitto_sub topicname <options>, where options are:\n");
  ...
  printf("  -showtop <on or off> (default is on if the topic has a wildcard, else off)\n");
	exit(-1);
}
